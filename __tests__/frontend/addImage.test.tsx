...
describe('test addimage component', () => {
    ...
    const file = new File(['data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAsUAAAKxCAYAAAC7eNHPAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUABIkkSURBVHgB7L0JoC1ZVR689q464x3f'],
        'example.jpg', { type: '.jpg' });
