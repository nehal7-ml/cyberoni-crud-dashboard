...
function DiscountsForm({ initial, method, action
}: FormProps) {
                ...
                <form onSubmit={handleSubmit} className="">
                    ...
                    <div className="mb-4">
                        <input
                            ...
                            onChange={(e) =>
                                setDiscountData((prev) => ({ ...prev, name: e.target.value.toUpperCase() }))
                            }
                        />
                        <input
                            type="text"
                            ...
                            onChange={(e) =>
                                setDiscountData((prev) => ({ ...prev, value: isNaN(Number(e.target.value)) ? 0 : Number(e.target.value) }))
                            }
                        />
                    </div>
