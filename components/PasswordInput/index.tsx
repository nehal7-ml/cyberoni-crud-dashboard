...
import React, { HTMLAttributes, useState, MouseEventHandler, useEffect } from 'react';

const PasswordGenerator = (props: { onChange: any, name: string, value: string, className: string , required?:boolean}) => {
    ...
    useEffect(() => {
        if (showCheck) setTimeout(() => { setShowCheck(false) }, 300)
