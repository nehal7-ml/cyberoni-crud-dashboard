...
function GptCategoryForm({ onAddCategory }: { onAddCategory: (category: { name: string; id: string, children: { name: string; id: string }[],  }) => void }) {
    ...
    async function submit() {
        ...
        const res = await fetch(`/api/prompts/categories/add`, {
            method: 'POST',
...
export default GptCategoryForm;