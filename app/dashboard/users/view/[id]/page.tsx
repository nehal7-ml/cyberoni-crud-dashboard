...
const CreateUserForm: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const res = await fetch(`${apiUrl}/users/${params.id}`, { method: 'PUT', body: JSON.stringify(userData), headers })
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            ...
            // Send the userData to your backend for creating the user
            const res = await fetch(`${apiUrl}/users/${params.id}`, { method: 'GET', headers })
            let resJson = await res.json();
            console.log(resJson)
