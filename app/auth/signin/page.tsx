            ...
            <div className="container mx-auto max-w-md">
                ...
                <form method="post" action="/api/auth/callback/credentials" className="flex flex-col p-5 lg:p-10 bg-gray-50 text-gray-950 rounded-[30px] shadow-lg">
                    ...
                    <div className="relative my-10">
                        ...
                        <ClientInput
                            className="peer shadow-lg appearance-none border rounded-xl w-full py-4 px-4 bg-transparent text-gray-700 dark:text-gray-200 leading-tight focus:outline-none focus:shadow-outline"
                            name="email"
                            id="email"
                            type="email"
                            placeholder=""
